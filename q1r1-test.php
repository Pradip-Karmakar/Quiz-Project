...
<html>
  ...
  <body>
    <div class="container">
      <div class="row" style="margin-top:15vh">
        <div class="col-md-6 offset-3">
          <h1 class="text-center">END IN <i class="fa fa-clock-o" aria-hidden="true"></i> </h1>
        </div>
      </div>
      <div class="row" style="margin-top:5vh">
        <div class="col-md-8 offset-2">
          <form action="q1r1-res.php" method="post" id="myform">
            <?php
            $qid = 0;
            $sql = "SELECT * FROM round1q ORDER BY RAND() LIMIT 15";
    ...
    function disableF(e) {
    if ((e.which || e.keyCode) == 116 || (e.which || e.keyCode) == 123 || (e.which || e.keyCode) == 122){ e.preventDefault();}
    };
