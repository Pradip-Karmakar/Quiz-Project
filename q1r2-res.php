  ...
  <div class="container">
		...
		<div class="row">
			...
			for ($i=0; $i < $cnt; $i++) {
				...
				$sql = "SELECT * FROM round2q WHERE id = '$qid[$i]'";
...
<?php
$sql1 = "insert into round2res(fname,mname,lname,urname,tot,nota,atq,ra,wa,mark,time) values('$fname','$mname','$lname','$urname','$cnt','$nota','$an','$ra','$wa','$mark','$di')";
