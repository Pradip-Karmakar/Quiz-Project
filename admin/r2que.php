<?php
    ...
    if (isset($_POST['submit'])) {
      ...
      $ra = mysqli_real_escape_string($con,$_POST['ra']);
        ...
        $sql = "insert into round1q(question,option1,option2,option3,option4,answer) values('$que','$o1','$o2','$o3','$o4','$ra')";
   ...
   <div class="container-fluid">
     ...
     <div class="card mb-3">
       ...
       <form method="post" id="lol">
         ...
         <div class="card-header"><i class="fa fa-plus" aria-hidden="true"></i> Round 2 Add Question </div>
